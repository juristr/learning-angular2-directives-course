...
declare module "material-design-lite/material" {
    export function upgradeDom(optJsClass, optCssClass): any;
    export function upgradeElement(element, optJsClass): any;
    export function upgradeElements(elements): any;
    export function upgradeAllRegistered(): any;
    export function registerUpgradedCallback(jsClass, callback): any;
    export function register(config): any;
    export function downgradeElements(nodes): any;
}
